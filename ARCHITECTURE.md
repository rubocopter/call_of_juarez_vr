...
23. flat-theater interaction adds a renderer-owned Sense ray/cursor and exact-CoJ menu click bridge with dedicated UI-select actions, focus/ray-loss release, Create re-anchor support and a transition fence that prevents a held menu trigger becoming a gameplay shot — host-tested; the failed run never produced flat content, and corrected candidate `20260919T213924Z-d5d149a5bf46` is staged for one-process physical validation.
